...
<nav>
  <ul>
    <li><p>Welcome <span>John Doe</span></p><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvjBD39JYJwj_uy63NMPIrweOPGmrq-TY3YPNvYorvWc_j2T53"></li>
    ...
    <a href="#"><li> Sign Out <i class="fa fa-sign-out" aria-hidden="true"></i></li></a>
  </ul>
</nav>
